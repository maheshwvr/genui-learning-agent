...
interface MCQLoadingProps {
  className?: string;
}

export function MCQLoading({ className }: MCQLoadingProps) {
  return (
      ...
      <CardContent className="p-6">
        <div className="flex items-center justify-center gap-3 mb-4">
          ...
          <div className="flex items-center gap-2">
            <span className="text-lg font-semibold text-primary">MCQ loading</span>
        ...
        <p className="text-sm text-primary/80 text-center font-medium">
          Generating a practice question for you...
        </p>
